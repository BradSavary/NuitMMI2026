 ...
 */
export class Spell {
  constructor(p5Instance, x, y, element, isUltimate = false, isAOE = false, customSpeed = null, customDamage = null) {
    this.p5 = p5Instance;
    ...
    this.speed = customSpeed !== null ? customSpeed : GAME_CONFIG.SPELL.SPEED;
...
export class SpellFactory {
   ...
   * Plus lent mais plus puissant que les autres sorts
   */
  static createEarthquake(p5Instance, x, y) {
    const slowSpeed = 6; // Plus lent que la vitesse normale (10)
    const highDamage = 5; // Plus de dégâts que les sorts normaux (2)
    return new Spell(p5Instance, x, y, GAME_CONFIG.ELEMENTS.EARTH, false, true, slowSpeed, highDamage);
  }
