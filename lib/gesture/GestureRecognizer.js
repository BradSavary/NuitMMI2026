...
export class GestureRecognizer {
  constructor(options = {}) {
    ...
    this.thresholds = {
      ...
      horizontalLine: options.horizontalLineThreshold || 0.6, // Réduit de 0.75 à 0.6
      verticalLine: options.verticalLineThreshold || 0.6, // Réduit aussi pour cohérence
  ...
  checkHorizontalLine(trail) {
    if (trail.length < 15) return 0; // Moins de points requis (était 20)
    ...
    if (xRange < 60) return 0; // Ligne plus courte acceptée (était 100)
    ...
    // Retourner la confiance même si < 0.7 (le seuil global décidera)
    return horizontality * linearity * 0.95; // Légèrement boosté
  }
